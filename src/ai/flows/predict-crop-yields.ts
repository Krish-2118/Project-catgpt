...
const prompt = ai.definePrompt({
  ...
  Based on the following information, predict the crop yield for the specified crop and region, and provide actionable recommendations for farmers to optimize their farming practices.
